  ...
  <div class="d-flex align-items-stretch">
    ...
    <div class="page-holder w-100 d-flex flex-wrap">
      ...
      <div class="container-fluid button-add">
           <button class="btn btn-primary col-lg-3 ml-6" type="button" 
           onclick="if(confirm('Are you sure want to Clear All SystemLog!')) window.location.href='<c:url value="/manager/clearlog"/>'">Clear Log</button>
      </div>
...
<!-- bắt đầu bảng -->
                ...
                <div class="card">
                  <div class="card-header">
                    <h6 class="text-uppercase mb-0">Activity log</h6>
                  </div>
                  <div class="card-body">                           
...
<!-- kết thúc bảng -->
  ...
  (function() {
	    document.getElementById("logmageractive").className += " active";
		})();
  </script>
  <!-- JavaScript files-->
