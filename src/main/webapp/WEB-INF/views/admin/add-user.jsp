              ...
              <div class="col-lg-12 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h3 class="h6 text-uppercase mb-0">USER INFORMATION</h3>
                  </div>
                  <div class="card-body">
                    <s:form class="form-horizontal" modelAttribute="user" action="saveProcess" enctype="multipart/form-data" method="POST">
                    <s:hidden path="id_user"/>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9" style="display: flex;">
                          ...
                          <c:if test = "${not empty user.images}">
                         		<span>Old Images: <a href="${user.images}">${user.images}</a> </span>
						   </c:if>
                        </div>
                      </div>
                      <div class="line"></div>
                      ...
                      <div class="line"></div>
                      <div class="form-group row">
                        <label class="col-md-3 form-control-label">Enable?</label>
                        <div class="col-md-2 select mb-3">
                          <s:select path="is_enable" class="form-control">
                      ...
                      <div class="form-group row">
                        <div class="col-md-9 ml-auto">
                          <button type="button" class="btn btn-secondary" onclick="if(confirm('Are you sure want to Cancel?')) window.location.href='<c:url value="/manager/user"/>'">Cancel</button>
