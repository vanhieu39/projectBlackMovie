  ...
  <div class="d-flex align-items-stretch">
    ...
    <div class="page-holder w-100 d-flex flex-wrap">
      ...
      <div class="container-fluid button-add">
           ...
           <button onclick="window.location.href = 'form-genre'; return false;"
		    class="btn btn-success">Add genre</button>
...
<!-- bắt đầu bảng -->
                ...
                <div class="card">
                  ...
                  <div class="card-body">  
                      ...
                      <tbody>
						<c:forEach items="${list_genres}" var="g" varStatus="ind">
							<c:url var="updateLink" value="/manager/form-update">
							<c:param name="categoryId" value="${g.genre_id}" />
							</c:url>
							<c:url var="deleteLink" value="/manager/deleteGenre">
								<c:param name="genreId" value="${g.genre_id}" />
							</c:url>
						<tr>
							<td>${ind.count}</td>
							<td>${g.genre_id}</td>
							...
							<td><a href="${deleteLink}" onclick="if(!(confirm('Are you sure want to delete this genre permanently?')))
