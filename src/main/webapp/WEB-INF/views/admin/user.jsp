  ...
  <div class="d-flex align-items-stretch">
    ...
    <div class="page-holder w-100 d-flex flex-wrap">
      ...
      <div class="container-fluid px-xl-9 button-add ">
           <button class="btn btn-primary col-lg-3 ml-6 " type="button" onclick="window.location.href='<c:url value="/manager/showFormAddUser"/>'">Add Manager Account</button>
...
<!-- kết thúc bảng -->
  ...
  (function() {
	    document.getElementById("usermanageractive").className += " active";
		})();
  </script>
  <!-- JavaScript files-->
