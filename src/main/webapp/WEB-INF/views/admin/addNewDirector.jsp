              ...
              <div class="col-lg-12 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h3 class="h6 text-uppercase mb-0">DIRECTOR INFORMATION</h3>
                  </div>
                  <div class="card-body">
                    <s:form class="form-horizontal" modelAttribute="director" action="saveDirector" method="POST" enctype="multipart/form-data">
                    <s:hidden path="id" />
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-2">
                        	<c:if test = "${director.birthday == null}">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9" style="display: flex;">
                          ...
                          <c:if test = "${not empty director.images}">
                         		<span>Old Images: <a href="${director.images}">${director.images}</a> </span>
						   </c:if>
                        </div>
                      </div>
                      <div class="line"></div>
                      ...
                      <div class="form-group row">
                        <div class="col-md-9 ml-auto">
                          <button type="button" class="btn btn-secondary" onclick="if(confirm('Are you sure want to Cancel?')) window.location.href='<c:url value="/manager/directors"/>'">Cancel</button>
