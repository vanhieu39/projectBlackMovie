...
<!-- bắt đầu bảng -->
                ...
                <div class="card">
                  <div class="card-header">
                    <h6 class="text-uppercase mb-0">List Actor</h6>
                  </div>
                  <div class="card-body">                           
                    <table class="table table-striped table-hover card-text">
                      ...
                      <tbody>
                        <c:forEach items="${ listactor}" var="e">
							<c:url var="deleteLink" value="/manager/deleteActor">
								<c:param name="actorID" value="${e.id_actor}"/>
							</c:url>
							<c:url var="updateLink" value="/manager/updateActor">
								<c:param name="actorID" value="${e.id_actor}"/>
							</c:url>
							<tr>
								<td>${e.fullname }</td>
...
<!-- kết thúc bảng -->
  ...
  (function() {
	    document.getElementById("actormanageractive").className += " active";
		})();
  </script>
  <!-- JavaScript files-->
